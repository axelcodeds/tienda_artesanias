    ...
    if(isset($_GET['id']) && is_numeric($_GET['id'])){
        ...
        if(isset($_SESSION['carrito'])){ //SI EL CARRITO EXISTE
            //SI EL artesania EXISTE EN EL CARRITO
            if(array_key_exists($id,$_SESSION['carrito'])){
                actualizarartesania($id);
            }else{
                //  SI EL CARRITO NO EXISTE EN EL CARRITO
                agregarartesania($resultado, $id);
            }
    ...
    <body>
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="index.php">Artesanias Chilapa</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right">
                <li>
                <a href="" class="btn">CARRITO <span class="badge"><?php print cantidadartesanias(); ?></span></a>
                </li> 
            </ul>
            </div><!--/.nav-collapse -->
        </div>
                        ...
                        ?>
                            <tr>
                                <form action="actualizar_carrito.php" method="post">
                                    <td><?php print $c ?></td>
                                    <td><?php print $value['nombre_artesania']  ?></td>
                                    <td>
                                        <?php
