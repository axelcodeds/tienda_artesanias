    ...
    <body>
        ...
        <div class="container" id="main">
            ...
            <div class="col-md-12">
                <fieldset>
                <legend>Listado de Artesanias</legend>
                    ...
                    <tbody> 
                        ...
                        $info_artesania = $artesania->mostrar();

                        
                        $cantidad = count($info_artesania);
                        if($cantidad > 0){
                            $c=0;
                        for($x =0; $x < $cantidad; $x++){
                            $c++;
                            $item = $info_artesania[$x];
                        ?>


                        <tr>
                        <td><?php print $c?></td>
                        <td><?php print $item['nombre_artesania']?></td>
