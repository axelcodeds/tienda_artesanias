    ...
    if(isset($_GET['id']) && is_numeric($_GET['id'])){
        ...
        $resultado = $artesania->mostrarPorId($id);
    ...
    <body>
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="../dashboard.php">Artesanias Chilapa</a>
            </div>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="active">
                <a href="index.php" class="btn">Artesanias</a>
                </li>
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-md-12">
            <fieldset>
                <legend>Datos de la artesania</legend>
                <form method="POST" action="../acciones.php" enctype="multipart/form-data" >
                <input type="hidden" name="id" value="<?php print $resultado['id'] ?>">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Nombre Artesania</label>
                            <input value="<?php print $resultado['nombre_artesania'] ?>" type="text" class="form-control" name="nombre_artesania" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="categoria_id" required>
                                ...
                                <?php
                                require '../../vendor/autoload.php';
                                $categoria = new deadpool\Categoria;
